...
docker compose --file "$vaultwarden_files/compose.yml" --env-file "$env_file" --project-name vaultwarden pull
...
docker compose --file "$collabora_files/compose.yml" --env-file "$env_file" --project-name collabora pull
